...
DecentraLabs marketplace is developed as a [Next.js](https://nextjs.org) project using the App Router.
...
You can start editing the page by modifying `src/app/layout.js` or `src/pp/page.js`. The page auto-updates as you edit the file.
