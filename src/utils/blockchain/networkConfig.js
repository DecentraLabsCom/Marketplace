...
export const alchemyNetworks = {
  ...
  [polygon.id]: process.env.NEXT_PUBLIC_ALCHEMY_POLYGON_URL,
...
export const moralisNetworks = {
  ...
  //[polygon.id]: process.env.NEXT_PUBLIC_MORALIS_POLYGON_URL,
...
export const ankrNetworks = {
  ...
  //[polygon.id]: process.env.NEXT_PUBLIC_ANKR_POLYGON_URL,
...
export const quicknodeNetworks = {
  ...
  //[polygon.id]: process.env.NEXT_PUBLIC_QUICKNODE_POLYGON_URL,
...
export const chainstackNetworks = {
  ...
  //[polygon.id]: process.env.NEXT_PUBLIC_CHAINSTACK_POLYGON_URL,
...
export const infuraNetworks = {
  ...
  [polygon.id]: process.env.NEXT_PUBLIC_INFURA_POLYGON_URL,
