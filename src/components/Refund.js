...
export default function Refund() {
    ...
    return (
        <button onClick={openModal} className='px-3 py-1 rounded-full text-sm bg-orange-500 hover:bg-orange-300
        text-white'>
        {/* Modal */}
            {isModalOpen && (
                ...
                onClick={(e) => e.stopPropagation()}>
                    ...
                    {/* No onClick: Implement missing refund procedure logic here */}
