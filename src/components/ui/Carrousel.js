      ...
      <>
        ...
        {images.map((_, index) => (
          <button key={index} type="button" data-twe-slide-to={index}
            ...
            border-solid border-transparent bg-white hover:bg-primary-500 bg-clip-padding p-0 indent-[999px] opacity-50 
            transition-opacity duration-[600ms] ease-[cubic-bezier(0.25,0.1,0.25,1.0)] motion-reduce:transition-none 
            ${ index === currentIndex ? 'opacity-100 bg-primary-400' : '' }`}
