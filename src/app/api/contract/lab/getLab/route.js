...
export async function GET(request) {
  ...
  try {
    ...
    // Contract returns: { "0": labId, "1": [uri, price, accessURI, accessKey, createdAt, resourceType] }
    // Transform to: { labId, base: { uri, price, accessURI, accessKey, createdAt, resourceType } }
